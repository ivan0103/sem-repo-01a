...
public class GatewayService implements ReactiveUserDetailsService {
    ...
    public Mono<UserDetails> findByUsername(String netID) {
        try {
            ...
            return Mono.just(new org.springframework.security
                    .core.userdetails.User(authUser.getNetID(),
    ...
    //     * @throws UsernameNotFoundException when the
    //     username searched for doesn't have an account.
    //     */
    //    @Override
